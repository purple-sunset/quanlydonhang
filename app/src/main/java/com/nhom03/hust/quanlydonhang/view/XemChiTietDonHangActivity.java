...
public class XemChiTietDonHangActivity extends AppCompatActivity {
    ...
    public void xemHangHoa(View view) {
        ...
        intent3.putExtra("DsCTHH", donHang.getDsHang());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode){
            ...
            case REQUEST_CODE_HANGHOA: {
                Log.d("Return From", "Hang Hoa");
                switch (resultCode) {
                    case RESULT_CODE_CHON_HANGHOA: {
                        ArrayList <ChiTietDonHang> hh = (ArrayList<ChiTietDonHang>) data.getExtras().getSerializable("Return_HH");
                        donHang.setDsHang(hh);
                        break;
                    }
                }
                break;
